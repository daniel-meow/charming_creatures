...
users = []
users << User.create(email: "seb@lewagon.org", encrypted_password: "123456", address: "Tempelhofer Strasse 5", goal: "125.75" )
users << User.create(email: "timo@home.org", encrypted_password: "123456", address: "Samsungweg 78", goal: "326.89" )
users << User.create(email: "winnie@puh.org", encrypted_password: "123456", address: "Honigweg 7", goal: "425.56" )
